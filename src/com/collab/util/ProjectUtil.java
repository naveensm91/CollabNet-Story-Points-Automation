...
import com.collabnet.ce.soap50.webservices.cemain.*;
import com.collabnet.ce.soap50.webservices.ClientSoapStubFactory;


/**
 * This example class retrieves various data associated with TeamForge
...
public class ProjectUtil
{
    ...
    * <p>
    * @param userName A TeamForge user account used to filter the project list
    ...
    * @throws RemoteException if any errors occur during TeamForge calls that exception
      ...
      throws RemoteException
   {
      ...
      try
      {
         /* retrieve from TeamForge a list of members of projectId */
